...
- **Microservices Architecture:** Includes service discovery, configuration server, authentication/authorization, and decoupled domain services (catalog, inventory, orders, notifications).
