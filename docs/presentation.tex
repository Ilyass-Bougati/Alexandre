...
\begin{frame}{Problématique}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.32\textwidth}
      \centering
      {\color{primary}\faExchangeAlt}\\[4pt]
      \textbf{Communication}\\
...
\begin{frame}{Présentation du Projet — Alexandre}
  ...
  \begin{block}{\faShoppingCart\quad Qu'est-ce qu'Alexandre ?}
    Plateforme e-commerce basée sur une architecture microservices, conçue comme
    \textbf{projet d'apprentissage} et de démonstration des patterns d'architecture
    distribuée moderne.
  \end{block}
